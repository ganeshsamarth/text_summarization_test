...
modelLocation="/home/pbu/Bidirectiona-LSTM-for-text-summarization-/TrainedModels"
...
print(train_data['summaries'][0].shape)
train_data["article"]=np.array(train_data["article"])
print(train_data['article'][0].shape)
